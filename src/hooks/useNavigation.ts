...
export function useDeepLinkHandler() {
  ...
  const handleBattleInvite = useCallback(
  ...
  const handleSpotDeepLink = useCallback(
    (spotId: string) => {
  ...
  const handleShopItemDeepLink = useCallback(
    (itemId: string) => {
      navigation.navigate('Main', {
        screen: 'ShopStack',
        params: {
...
export function useModalNavigation() {
  ...
  const presentModal = useCallback(
    (screen: keyof RootStackParamList, params?: any, options?: any) => {
